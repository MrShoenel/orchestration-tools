...
class Interval {
   ...
   * @param {boolean} disabled if true, this Interval is disabled and does
   * nothing until enabled
   */
  constructor(msecs, itemProducer, waitforFinishProduction = true, triggerInitially = false, disabled = false) {
